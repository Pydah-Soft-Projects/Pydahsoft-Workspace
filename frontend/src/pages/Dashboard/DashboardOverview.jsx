    ...
    return (
      <div className="space-y-3 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-4">
          ...
          <div className="dashboard-section-hover bg-white p-1.5 sm:p-5 rounded-md sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div className="flex justify-between items-center">
              <span className="text-[8px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider">Active Projects</span>
              <div className="w-4 h-4 sm:w-8 sm:h-8 rounded-sm sm:rounded-lg bg-emerald-50 text-[#20b875] flex items-center justify-center font-bold text-[9px] sm:text-sm">
            ...
            <div className="mt-1 sm:mt-3 flex items-baseline justify-between">
              <span className="text-sm sm:text-3xl font-black text-[#09233d]">{totalProj}</span>
              <button
                onClick={() => setActiveTab('projects')}
                className="text-[8px] sm:text-xs font-bold text-[#20b875] hover:underline flex items-center gap-0.5 sm:gap-1"
              >
                <span className="inline-flex items-center gap-0.5 sm:gap-1">View All <Icon name="arrowRight" className="w-2 h-2 sm:w-3.5 sm:h-3.5" /></span>
              </button>
            </div>
            <div className="w-full bg-gray-100 h-0.5 sm:h-1.5 rounded-full mt-1 sm:mt-3 overflow-hidden">
          ...
          <div className="dashboard-section-hover bg-white p-1.5 sm:p-5 rounded-md sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div className="flex justify-between items-center">
              <span className="text-[8px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider">Teams & Members</span>
              <div className="w-4 h-4 sm:w-8 sm:h-8 rounded-sm sm:rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center font-bold text-[9px] sm:text-sm">
                <svg className="w-2.5 h-2.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </div>
            </div>
            <div className="mt-1 sm:mt-3 flex flex-wrap items-baseline justify-between gap-0.5 sm:gap-1">
              <span className="text-sm sm:text-3xl font-black text-[#09233d]">
                {summary.totalTeams || 0}{' '}
                <small className="text-[8px] sm:text-xs font-semibold text-gray-400">Teams</small>
              </span>
              <span className="text-[7.5px] sm:text-xs font-bold text-emerald-600 bg-emerald-50 px-1 sm:px-2.5 py-0.5 sm:py-1 rounded-full">
          ...
          <div className="dashboard-section-hover bg-white p-1.5 sm:p-5 rounded-md sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div className="flex justify-between items-center">
              <span className="text-[8px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider">Projects At Risk</span>
              <div className="w-4 h-4 sm:w-8 sm:h-8 rounded-sm sm:rounded-lg bg-rose-50 text-rose-600 flex items-center justify-center font-bold text-[9px] sm:text-sm">
                <svg className="w-2.5 h-2.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-1 sm:mt-3 flex items-baseline justify-between">
              <span className="text-sm sm:text-3xl font-black text-rose-600">{summary.projectsAtRisk || 0}</span>
              <span className="text-[7.5px] sm:text-xs font-medium text-gray-500 bg-slate-100 px-1 sm:px-2 py-0.5 rounded-md">
                {summary.delayedTasksCount || 0} Del / {summary.blockedTasksCount || 0} Blk
              </span>
            </div>
            <div className="w-full bg-gray-100 h-0.5 sm:h-1.5 rounded-full mt-1 sm:mt-3 overflow-hidden">
              <div
          ...
          <div className="dashboard-section-hover bg-white p-1.5 sm:p-5 rounded-md sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
            <div className="flex justify-between items-center">
              <span className="text-[8px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider">Org Efficiency</span>
              <div className="w-4 h-4 sm:w-8 sm:h-8 rounded-sm sm:rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-[9px] sm:text-sm">
                <svg className="w-2.5 h-2.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-1 sm:mt-3 flex items-baseline justify-between">
              <span className="text-sm sm:text-3xl font-black text-emerald-600">{safeEfficiency}%</span>
              <span className="text-[7.5px] sm:text-xs font-medium text-gray-500">
                {estHours}h / {actHours}h
              </span>
            </div>
            <div className="w-full bg-gray-100 h-0.5 sm:h-1.5 rounded-full mt-1 sm:mt-3 overflow-hidden">
              <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6">
          ...
          <div className="dashboard-section-hover bg-white p-2.5 sm:p-6 rounded-lg sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-center mb-2 sm:mb-4">
              <div>
                <h2 className="text-xs sm:text-base font-bold text-[#09233d]">Project Status & Risk Breakdown</h2>
                <p className="text-[9px] sm:text-xs text-gray-400">Distribution of projects across lifecycle stages</p>
              </div>
              <span className="text-[9px] sm:text-xs font-bold text-[#20b875] bg-emerald-50 px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-lg">
                Pie / Donut Graph
              </span>
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-around py-1.5 sm:py-4 gap-2 sm:gap-6">
              {/* SVG Donut Chart */}
              <div className="relative w-24 h-24 sm:w-44 sm:h-44 flex items-center justify-center shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                  <span className="text-base sm:text-2xl font-black text-[#09233d]">{totalProj}</span>
                  <span className="text-[7px] sm:text-[10px] font-bold text-gray-400 uppercase tracking-wider">Total Projects</span>
                </div>
              </div>

              {/* Legend & Breakdown Stats */}
              <div className="grid grid-cols-2 sm:flex sm:flex-col gap-1 sm:gap-3 w-full sm:w-auto">
                {donutData.map((item, idx) => {
                  const pct = Math.round((item.count / validDonutTotal) * 100);
                  return (
                    <div key={idx} className="flex items-center justify-between gap-1 sm:gap-4 p-1 sm:p-2 rounded-lg bg-gray-50 border border-gray-100 min-w-0 sm:min-w-[170px]">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <span className="w-2 h-2 sm:w-3 sm:h-3 rounded-full shrink-0" style={{ backgroundColor: item.color }} />
                        <span className="text-[9px] sm:text-xs font-bold text-gray-700 truncate">{item.label}</span>
                      </div>
                      <div className="text-right shrink-0">
                        <span className="text-[9px] sm:text-xs font-black text-[#09233d] block">{item.count}</span>
                        <span className="text-[8px] sm:text-[10px] font-medium text-gray-400">{pct}%</span>
                      </div>
                    </div>
                  );
                })}
          ...
          <div className="dashboard-section-hover bg-white p-2.5 sm:p-6 rounded-lg sm:rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-center mb-2 sm:mb-4">
              <div>
                <h2 className="text-xs sm:text-base font-bold text-[#09233d]">Resource Time Allocation Graph</h2>
                <p className="text-[9px] sm:text-xs text-gray-400">Comparison of Estimated vs Actual logged hours</p>
              </div>
              <span className="text-[9px] sm:text-xs font-bold text-blue-600 bg-blue-50 px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-lg">
                Bar Chart
              </span>
            </div>

            <div className="py-1 sm:py-2 space-y-2 sm:space-y-6">
              {/* Estimated Hours Bar */}
              <div>
                <div className="flex justify-between items-center text-[9px] sm:text-xs font-bold mb-0.5 sm:mb-1">
                  <span className="text-gray-600 flex items-center gap-1 sm:gap-1.5">
                    <span className="w-1.5 h-1.5 sm:w-2.5 sm:h-2.5 rounded-sm bg-blue-500 inline-block"></span> Total Estimated Hours
                  </span>
                  <span className="text-[#09233d] font-black">{estHours} Hours</span>
                </div>
                <div className="w-full bg-gray-100 h-3.5 sm:h-6 rounded-md sm:rounded-xl overflow-hidden p-0.5 sm:p-1 border border-gray-100 flex items-center">
                  <div
                    className="bg-blue-500 h-full rounded-sm sm:rounded-lg transition-all duration-700 flex items-center justify-end pr-1 sm:pr-2 text-[7px] sm:text-[10px] text-white font-bold"
              ...
              <div>
                <div className="flex justify-between items-center text-[9px] sm:text-xs font-bold mb-0.5 sm:mb-1">
                  <span className="text-gray-600 flex items-center gap-1 sm:gap-1.5">
                    <span className="w-1.5 h-1.5 sm:w-2.5 sm:h-2.5 rounded-sm bg-[#20b875] inline-block"></span> Total Actual Logged Hours
                  </span>
                  <span className="text-[#09233d] font-black">{actHours} Hours</span>
                </div>
                <div className="w-full bg-gray-100 h-3.5 sm:h-6 rounded-md sm:rounded-xl overflow-hidden p-0.5 sm:p-1 border border-gray-100 flex items-center">
                  <div
                    className="bg-[#20b875] h-full rounded-sm sm:rounded-lg transition-all duration-700 flex items-center justify-end pr-1 sm:pr-2 text-[7px] sm:text-[10px] text-white font-bold"
                    style={{
              ...
              <div className="p-2 sm:p-3.5 bg-emerald-50/60 rounded-md sm:rounded-xl border border-emerald-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1.5 sm:gap-2">
                <div className="flex items-center gap-1.5 sm:gap-2.5">
                  <div className="w-4 h-4 sm:w-7 sm:h-7 rounded-md sm:rounded-lg bg-emerald-100/80 text-emerald-700 flex items-center justify-center shrink-0">
                    <svg className="w-2.5 h-2.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <strong className="text-[9px] sm:text-xs font-bold text-emerald-900 block">Execution Status</strong>
                    <span className="text-[8px] sm:text-[11px] text-emerald-700">
                      {actHours <= estHours ? 'Project work is within allocated budget limits.' : 'Actual hours exceed estimated allocation.'}
                    </span>
                  </div>
                </div>
                <span className="text-[9px] sm:text-xs font-black text-emerald-700 bg-white px-1.5 sm:px-3 py-0.5 sm:py-1 rounded-md sm:rounded-lg border border-emerald-200 shadow-2xs">
        ...
        <div className="dashboard-section-hover bg-white p-2.5 sm:p-6 rounded-lg sm:rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex justify-between items-center mb-2 sm:mb-4">
            <div>
              <h2 className="text-xs sm:text-base font-bold text-[#09233d]">Live Project Lifecycle Progress</h2>
              <p className="text-[9px] sm:text-xs text-gray-400">Visual progress indicators for active company projects</p>
            </div>
            <button
              onClick={() => setActiveTab('projects')}
              className="text-[9px] sm:text-xs font-bold text-[#20b875] hover:underline"
            >
              <span className="inline-flex items-center gap-0.5 sm:gap-1">Manage Projects <Icon name="arrowRight" className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5" /></span>
            </button>
          </div>
          ...
          <div className="space-y-2 sm:space-y-4">
            {activeProjects.length === 0 ? (
              ...
              activeProjects.map((proj) => {
                ...
                return (
                  <div key={proj._id} className="p-2 sm:p-4 bg-gray-50 rounded-md sm:rounded-xl border border-gray-100 hover:border-emerald-200 transition-colors">
                    <div className="flex justify-between items-center mb-1 sm:mb-2">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <span className="text-[9px] sm:text-xs font-bold text-[#20b875] bg-emerald-50 px-1 sm:px-2.5 py-0.5 rounded-md border border-emerald-100">
                          {proj.projectId || 'PRJ'}
                        </span>
                        <strong className="text-[11px] sm:text-sm font-bold text-[#09233d]">{proj.name}</strong>
                      </div>
                      <span className="text-[9px] sm:text-xs font-extrabold text-slate-700 bg-white px-1.5 sm:px-2.5 py-0.5 sm:py-1 rounded-md border border-gray-200 shadow-2xs">
                        {prog}% Completed
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 h-1.5 sm:h-3 rounded-full overflow-hidden p-0.5">
                      <div
